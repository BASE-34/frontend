...
<div class="flex flex-col min-h-screen bg-surface selection:bg-primary-container selection:text-primary">
  <Navbar />

  <div class="flex-1 relative flex flex-col items-center justify-center py-20 px-6 overflow-hidden">
    <!-- Scan line overlay -->
    <div class="scanline-fx"></div>

    <!-- Corner markers -->
    <div class="corner-marker cm-tl top-24 left-8"></div>
    <div class="corner-marker cm-tr top-24 right-8 transform scale-x-[-1]"></div>
    <div class="corner-marker cm-bl bottom-24 left-8 transform scale-y-[-1]"></div>
    <div class="corner-marker cm-br bottom-24 right-8 transform scale-[-1]"></div>
